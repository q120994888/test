...
<html>
  ...
  session.setAttribute("id", detail);
   %>
				...
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-edit"></i> 修改新闻</h2>
						<div class="box-icon">
					...
					<div class="box-content">
						<form action="doUpdate.jsp?id=${id.getId()}" method="post" class="form-horizontal">
						  <fieldset>
							<div class="control-group">
							  <label class="control-label" for="typeahead" >新闻标题 </label>
							  <div class="controls">
								<input type="text" class="span6 typeahead" id="typeahead"  name="title" value="<%=detail.getTitle()%>">
							  </div>
							</div>
							...
							<div class="control-group">
							  <label class="control-label" for="date01" name="modifyDate">修改日期</label>
							  <div class="controls">
								<input type="text" class="input-xlarge datepicker" value="02/16/22">
							  </div>
							</div>
